...
<?if($templateData['FILTER_URL']):?>
    <?$catalogIBlockID = $arParams['CATALOG_IBLOCK_ID'] ?? \Bitrix\Main\Config\Option::get('aspro.allcorp3', 'CATALOG_IBLOCK_ID', 252)?>
    ...
    $iCountElement = CAllcorp3Cache::CIblockElement_GetList(
        [
            'CACHE' => [
                'TAG' => CAllcorp3Cache::GetIBlockCacheTag($catalogIBlockID),
                'MULTI' => 'N'
            ]
        ], 
    ...
    <?if($iCountElement):?>
        ...
        <div class="detail-block ordered-block list_items">
            <?$isAjax = (CAllcorp3::checkAjaxRequest() ? 'Y' : 'N');?>
            ...
            <?\Aspro\Functions\CAsproAllcorp3::showBlockHtml([
                ...
                'PARAMS' => array_merge(
                    ...
                    array(
                        ...
                        "SHOW_PROPS_TABLE" => strtolower(CAllcorp3::GetFrontParametrValue('SHOW_TABLE_PROPS')),
