<a href="#" class="jqmClose top-close stroke-theme-hover"><?=CAllcorp3::showIconSvg('', SITE_TEMPLATE_PATH.'/images/svg/Close.svg')?></a>
<?if($arResult):?>
	<?
	// preview image
						...
						<?if(
							...
							<div class="line-block__item">
								<div class="popup-sale__item-timer">
									...
									<?endif;?>
									<?if($bDiscountCounter):?>
										<?\Aspro\Functions\CAsproAllcorp3::showDiscountCounter(['ITEM' => $arResult]);?>
									<?endif;?>
								</div>
							</div>
						<?endif;?>
