...
<?if($arResult['ITEMS']):?>
	...
	<?endif;?>
			...
			foreach($arResult['ITEMS'] as $i => $arItem):?>
				...
				// photos
				$arPhotos = (array_key_exists('PHOTOS', $arItem['PROPERTIES']) && $arItem['PROPERTIES']['PHOTOS']['VALUE']) ? (array)$arItem['PROPERTIES']['PHOTOS']['VALUE'] : (array)$arItem['PROPERTY_PHOTOS_VALUE'];
							...
							<div class="gallery-list__item-additional-text-wrapper">
								<div class="gallery-list__item-additional-text-top-part">
									<?if(
										...
										<div class="gallery-list__item-photos-count font_13 color_light--opacity"><?=Aspro\Functions\CAsproAllcorp3::declOfNum(
												count($arPhotos),
												array(
