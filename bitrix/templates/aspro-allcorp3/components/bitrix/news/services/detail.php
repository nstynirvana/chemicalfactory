...
$bShowLeftBlock = ($arTheme['LEFT_BLOCK_SERVICES_DETAIL']['VALUE'] === 'Y' && !defined('ERROR_404'));
...
<?else:?>
	...
	<div class="detail detail-maxwidth js-popup-block <?=($templateName = $component->{'__template'}->{'__name'})?>" itemscope itemtype="http://schema.org/Service">
