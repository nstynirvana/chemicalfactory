...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"USE_DETAIL_TABS" => $arParams["USE_DETAIL_TABS"] == 'FROM_MODULE' ? $GLOBALS['arTheme']['USE_DETAIL_TABS_TARIFFS']['VALUE'] : $arParams['USE_DETAIL_TABS'],
		...
		"VISIBLE_PROP_COUNT" => $arParams['DETAIL_VISIBLE_PROP_COUNT'],
