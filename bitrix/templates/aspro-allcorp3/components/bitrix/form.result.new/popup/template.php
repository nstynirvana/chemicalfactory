			...
			<div class="form-body">
				<?if(is_array($arResult["QUESTIONS"])):?>
					<?foreach($arResult["QUESTIONS"] as $FIELD_SID => $arQuestion):?>
						<?CAllcorp3::drawFormField($FIELD_SID, $arQuestion);?>
					<?endforeach;?>				
				<?endif;?>
			...
			<div class="form-footer">
				<?if($arParams["SHOW_LICENCE"] == "Y"):?>
					<div class="licence_block form-checkbox">
						...
						<input type="checkbox" class="form-checkbox__input form-checkbox__input--visible" id="licenses_popup_<?=$arResult["arForm"]["ID"];?>" <?=(COption::GetOptionString("aspro.allcorp3", "LICENCE_CHECKED", "N") == "Y" ? "checked" : "");?> name="licenses_popup" required value="Y">
