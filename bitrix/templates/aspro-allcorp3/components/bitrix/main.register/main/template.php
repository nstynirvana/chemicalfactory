						...
						<form id="registraion-page-form" method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data" >
							...
							<?if ($arResult["USE_CAPTCHA"] == "Y"){?>
								<div class="row captcha-row captcha-row--inline">
									<div class="col-md-12">
										<label for="captcha_word" class="font_13 color_666"><?=(\Aspro\Functions\CAsproAllcorp3ReCaptcha::checkRecaptchaActive() ? GetMessage("FORM_GENERAL_RECAPTCHA") : GetMessage("REGISTER_CAPTCHA_PROMT"))?> <span class="required-star">*</span></label>
							...
							<?}?>
							<?if(COption::GetOptionString("aspro.allcorp3", "SHOW_LICENCE", "N") == "Y"):?>
								<div class="form-group bg-color">
									<div class="wrap_md">
										<div class="iblock label_block">
											<div class="licence_block form-checkbox">
												<input type="checkbox" id="licenses_reg" name="licenses_popup" <?=($arTheme["SHOW_LICENCE"]["DEPENDENT_PARAMS"]["LICENCE_CHECKED"]["VALUE"] == "Y" ? "checked" : "");?> required value="Y" class="form-checkbox__input">
