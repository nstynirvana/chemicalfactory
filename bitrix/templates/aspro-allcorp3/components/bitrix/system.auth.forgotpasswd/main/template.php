				...
				<div class="max-form-block">
					...
					<?if($arResult["USE_CAPTCHA"]):?>
						<div class="captcha-row clearfix forget_block  captcha-row--inline">
							<label  class="font_13 color_999"><span><?=(\Aspro\Functions\CAsproAllcorp3ReCaptcha::checkRecaptchaActive() ? GetMessage("FORM_GENERAL_RECAPTCHA") : GetMessage("FORM_CAPRCHE_TITLE_RECAPTCHA2"))?>&nbsp;<span class="required-star">*</span></span></label>
