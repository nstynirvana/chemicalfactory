	...
	<div class="catalog-detail__item flex-1">
		<? $APPLICATION->IncludeComponent(
			...
			array(
				...
				"T_COMPLECTS" => ($arParams["T_COMPLECTS"] ? $arParams["T_COMPLECTS"] : GetMessage("T_COMPLECTS")),
				...
				'GALLERY_THUMB_POSITION' => CAllcorp3::GetFrontParametrValue('CATALOG_PAGE_DETAIL_THUMBS'),
				"USE_GIFTS_DETAIL" => 'N',
				...
				"DETAIL_BLOCKS_ALL_ORDER" => ($arParams["DETAIL_BLOCKS_ALL_ORDER"] ? $arParams["DETAIL_BLOCKS_ALL_ORDER"] : 'sale,desc,char,reviews,big_gallery,video,services,news,articles,docs,licenses,staff,faq,projects,partners,vacancy,goods,custom_tab,comments, complects'),
