														...
														<?foreach ($arItem["PROPS"] as $arProp):?>
															<?if (!empty( $arProp["VALUE"])):?>
																<div class="properties__item font_13 js-prop-replace">
																	<span class="properties__title color_666 js-prop-title">
																		<?=$arProp["NAME"]?>
																	</span>
																	<span class="properties__hr color_666 properties__item--inline">&mdash;</span>
														...
														<?foreach ($arItem["OFFER_PROP"] as $arProp):?>
															<?if (!empty( $arProp["VALUE"])):?>
																<div class="properties__item font_13 js-prop">
																	<span class="properties__title color_666">
																		<?=$arProp["NAME"]?>
																	</span>
																	<span class="properties__hr color_666 properties__item--inline">&mdash;</span>
