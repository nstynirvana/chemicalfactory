...
$arResult["SHOW_PROPERTIES"] = CAllcorp3::PrepareItemProps($arResult["SHOW_PROPERTIES"]);
...
if($arParams["USE_COMPARE_GROUP"] === "Y"){
	if($arSectionsIDs){
		$arResult['SECTIONS'] = CAllcorp3Cache::CIBLockSection_GetList(array('SORT' => 'ASC', 'NAME' => 'ASC', 'CACHE' => array('TAG' => CAllcorp3Cache::GetIBlockCacheTag($arParams['IBLOCK_ID']), 'GROUP' => array('ID'), 'MULTI' => 'N')), array('ID' => $arSectionsIDs, 'ACTIVE' => 'Y'), false, array("ID", "NAME", "IBLOCK_ID"));
	}
...
// 	if($item["DISPLAY_PROPERTIES"]) {
// 		$arResult["ITEMS"][$itemID]["DISPLAY_PROPERTIES"] = CAllcorp3::PrepareItemProps($item['DISPLAY_PROPERTIES']);
// 	}
// }
?>